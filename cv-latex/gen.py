# -*- coding: utf-8 -*-
# Generates main.tex for Sergio Araneda's CV (LaTeX recreation of the Word/PDF CV)

def esc(s):
    return s  # content is pre-escaped where needed; we write raw LaTeX strings directly
...
def journals():
    out = ""
    out += r"""\pubentry{Araneda, S., Fremer, J., \& Foster, D. (2024). Commentary: Past, Present, and Future of
Educational Measurement. \textit{Educational Measurement: Issues and Practice}.
\link{https://doi.org/10.1111/emip.12632}{https://doi.org/10.1111/emip.12632}}
{edu_measurement.png}
"""
    out += r"""\pubentry{Araneda, S., Lee, D., Lewis, J., Sireci, S. G., Moon, J. A., Lehman, B., Arslan, B., \& Keehner, M.
...
\link{https://doi.org/10.3390/educsci12020104}{https://doi.org/10.3390/educsci12020104}}
{edc_sciences.png}
"""
    return out
...
("Foster, C., \\& Araneda, S. (2026). \\textit{Assessing Pre-Exposure Risks of LLM-Generated Item Pools} [Pre-print]. \\link{https://doi.org/10.13140/RG.2.2.25885.37602}{https://doi.org/10.13140/RG.2.2.25885.37602}", "researchgate.png"),
("Foster, C., Weaver, S., \\& Araneda, S. (2025). \\textit{Using ChatGPT for Semi-Automatic Generation of Items for Summative Assessment: A Case Study} [Pre-print]. \\link{https://doi.org/10.13140/RG.2.2.29947.78884}{https://doi.org/10.13140/RG.2.2.29947.78884}", "researchgate.png"),
("Araneda, S., Marder, A., Foster, C., \\& Foster, D. F. (2025). \\textit{Reliability in randomly parallel tests: A practical guide} [Preprint]. \\link{https://doi.org/10.13140/RG.2.2.22375.28329}{https://doi.org/10.13140/RG.2.2.22375.28329}", "researchgate.png"),
("Araneda, S., Wells, C., Colvin, K., O'Donell, F., Padellaro, F., \\& Foster, D. (2025). \\textit{Prompt Engineering for Binary Response Item Generation using ChatGPT} [Pre-print]. \\link{https://doi.org/10.13140/RG.2.2.23040.29448}{https://doi.org/10.13140/RG.2.2.23040.29448}", "researchgate.png"),
...
WHITEPAPERS = [
("Araneda, S. (2023). \\textsc{An Experiential Approach to Test Design and Validation} [Dissertation, University of Massachusetts Amherst]. Scholarworks@UMassAmherst. \\link{https://hdl.handle.net/20.500.14394/19086}{https://hdl.handle.net/20.500.14394/19086} \\link{https://www.youtube.com/watch?v=JD3EywvkcsU}{Link to Video}", "umass_seal.png"),
("Araneda, S., Beiting-Parrish, M., Bottoms, B., La Torre, D., McIntee, K., Musa, S., Sarac, M., Qingzhou, S., Tolentino, L., Tufail, M. \\& Valdivia Medinaceli, M. (2023). \\textit{Statement about the New Edition of the Standards for Educational \\& Psychological Testing} [White paper]. \\link{https://doi.org/10.31235/osf.io/dv4pa}{https://doi.org/10.31235/osf.io/dv4pa}", "ncme.png"),
("Araneda, S., Vargas, A. O., Ch\\'avez, C., de Padua, E., \\& G\\'andara, F. (2023). \\textit{PAES y el futuro de las pruebas para la admisi\\'on universitaria en Chile: \\textquestiondown son suficientes los cambios para un sistema de admisi\\'on equitativo?} [White paper]. \\link{https://doi.org/10.31235/osf.io/jh642}{https://doi.org/10.31235/osf.io/jh642}", "feved.png"),
]
# fix: use literal Unicode inverted question mark instead of textquestiondown (XeLaTeX-safe)
WHITEPAPERS[-1] = (WHITEPAPERS[-1][0].replace("\\textquestiondown ", "\u00bf"), WHITEPAPERS[-1][1])
_dummy = [
]

NEWSPAPERS = [
("Araneda, S. (2026, January 12th) Sobre el autoexilio. \\textit{El Desconcierto}. \\link{https://eldesconcierto.cl/2026/01/12/sobre-el-autoexilio}{https://eldesconcierto.cl/2026/01/12/sobre-el-autoexilio}", "el_desconcierto.png"),
("Araneda, S. (2024, January 9th) Ranking PAES sin interpretaci\\'on. \\textit{El Desconcierto}. \\link{https://eldesconcierto.cl/2024/01/09/ranking-paes-sin-interpretacion}{https://eldesconcierto.cl/2024/01/09/ranking-paes-sin-interpretacion}", "el_desconcierto.png"),
("Araneda, S. (2023, January 8th) PAES y \\textit{rankings}. \\textit{El Mercurio}.", "el_mercurio.png"),
("Araneda, S. (2022, December 1st) Fin a la PAES. \\textit{La Tercera}.", "la_tercera.png"),
("Araneda, S., Chavez, C., Fern\\'andez, MP., G\\'andara, F., Jimenez, F., Labarca, L., Osses Vargas, A., \\& Zunino, V. (2022, July 14th) Pruebas PAES y Manual T\\'ecnico. \\textit{La Tercera}.", "la_tercera.png"),
("Araneda, S., de Padua, E., G\\'andara, F., Labarca, L., Osses Vargas, A., Villa, S., Zepeda, S., \\& Zunino, V. (2022, July 3rd) Simce: una decisi\\'on errada. \\textit{El Mercurio}.", "el_mercurio.png"),
("Araneda, S., Chavez, C., de Padua N\\'ajera, E., G\\'andara, F., Jimenez, F. A., Osses, A., Zepeda, S., \\& Zunino Edelsberg, V. (2021, April 19th) Vuelta atr\\'as: reincorporaci\\'on de Simce lectura 2\\textsuperscript{o} b\\'asico. \\textit{La Tercera}.", "la_tercera.png"),
("Araneda, S. (2021, August 1st) Los riesgos de la PDT en tiempos de Covid-19. \\textit{El Desconcierto}. \\link{https://www.eldesconcierto.cl/opinion/2021/01/08/los-riesgos-de-la-prueba-de-transicion-pdt-en-tiempos-de-covid-19.html}{https://www.eldesconcierto.cl/opinion/2021/01/08/los-riesgos-de-la-prueba-de-transicion-pdt-en-tiempos-de-covid-19.html}", "el_desconcierto.png"),
]

CONF_ORGANIZED = [
("Araneda, S. (Chair), Ercikan, K., Solano-Flores, G., Dept, S., Gonthier, I., \\& Sireci, S. G. (Discussant). (2026, July 2). \\textit{Emerging challenges in the use of artificial intelligence in educational testing \\& certification} [Symposium]. International Test Commission Conference 2026, Auckland, New Zealand.", "itc_2026.png"),
("Araneda, S. (Chair), Padilla, J.-L., Ben\\'itez, I., Su\\'arez-\\'Alvarez, J., Solano-Flores, G., Ruiz-Primo, M. A., \\& Sireci, S. G. (Discussant). (2026, July 1). \\textit{Hispanic-American perspectives on the concept of validity} [Symposium]. International Test Commission Conference 2026, Auckland, New Zealand.", "itc_2026.png"),
("Araneda, S. (Organizer), Toton, S., Foster, C., Marder, A., \\& Foster, D. (Discussant). (2025, November 4). \\textit{New AI-driven threats to test security: Understanding risks and building defenses} [Organized conference session]. Conference on Test Security (COTS 2025), University of Massachusetts Amherst, Amherst, MA, United States.", "cots2025.png"),
("Araneda, S. (Organizer), Foster, C., McCaffrey, D., Hoffman, A., Beiting-Parrish, M., \\& von Davier, M. (Discussant). (2025, October 28). \\textit{Validating AI in educational testing: Challenges and future directions} [Organized session]. AIME Conference (AIME-Con), National Council on Measurement in Education (NCME), Pittsburgh, PA, United States.", "aimecon.png"),
("Araneda, S. (Organizer), Fremer, J., Ladson-Billings, G., Sireci, S. (2025, April) \\textit{One Hundred Years of Criticisms Against Standardized Testing} [Organized Discussion]. National Council on Measurement in Education annual meeting, Denver. \\link{https://www.researchgate.net/publication/391704152_100_years_of_criticisms_against_standardized_testing}{Link to Slides}", "ncme.png"),
("Araneda, S. (Chair), Torres-Iribarra, D., Alarc\\'on-Bustamante, E., Gonzalez-Wegener, X., G\\'andara, F., Fremer, J. (Discussant). (2024, July) \\textit{College Admission in Chile: Inequity, Social Unrest, and More Testing} [Symposium]. International Testing Commission bi-annual meeting, Granada.", "itc.png"),
("Araneda, S. (Organizer), Sarac, M., Beiting-Parrish, M., Valdivia Medinaceli, M. B., Huff, S., Huff, K. (Discussant). (2023, April) \\textit{GSIC Standards Study Group: Recommendations from Graduate Students for Its New Version} [Paper Session]. National Council on Measurement in Education annual meeting, Chicago.", "ncme.png"),
]

CONF_PANEL = [
("Araneda, S., Olson, J., Sireci, S., \\& Drane, W. (2025, November 4). \\textit{Latest research and development in using generative AI for state assessment programs: Cutting edge R\\&D and applications for K--12 testing} [Conference panel]. Conference on Test Security (COTS 2025), University of Massachusetts Amherst, Amherst, MA, United States.", "cots2025.png"),
("Drane, W., Quesen, S., Araneda, S., Olson, J. (2024, October) \\textit{Use of Generative AI in Secure Item Development for State Assessment Programs: Recommendations for Future Implementation by States} [Panel Presentation]. Conference on Test Security, Salt Lake City. \\link{https://www.youtube.com/watch?v=Jz-2YqcuPTM}{Link to Video}", "cots_generic.jpg"),
("Chakraborty, R., \\& Jackson, J. A. (Chairs). (2023, April). \\textit{Navigating job opportunities and preparing for job markets: Let's get ready together} [Panel discussion]. Graduate Student Council Division D Fireside Chat, AERA 2023 Annual Meeting, InterContinental Chicago Magnificent Mile, Chicago, IL. Panelists: Boyd, B., Van Orman, D. S. J., Riley-Lepo, E., Araneda, S., \\& Choiseul-Praslin, B. D.", "aera.png"),
]

CONF_TRAINING = [
("Araneda, S., Foster, C., \\& Weaver, S. (2025, October 27). \\textit{Using generative AI for item construction: State-of-the-art and practical lessons} [Training session]. AIME Conference (AIME-Con), National Council on Measurement in Education (NCME), Pittsburgh, PA, United States.", "aimecon.png"),
]

CONF_INDIVIDUAL = [
("Araneda, S. (2026, July 2). \\textit{The Multiple Crises of Validity Theory in the Age of AI} [Conference presentation]. International Test Commission Conference 2026, Auckland, New Zealand. \\link{https://www.researchgate.net/publication/408184953_The_Multiple_Crises_of_Validity_Theory_in_the_Age_of_AI}{Link to Slides}", "itc_2026.png"),
("Araneda, S. (2026, July 1). \\textit{Making the case for an experiential approach to test design and validation} [Conference presentation]. International Test Commission Conference 2026, Auckland, New Zealand. \\link{https://www.researchgate.net/publication/408184695_Making_the_Case_for_An_Experiential_Approach_to_Test_Design_and_Validation}{Link to Slides}", "itc_2026.png"),
...
("Araneda, S. (2026, April). \\textit{Factor analysis in randomly parallel tests: Limitations and emerging solutions} [Conference presentation]. National Council on Measurement in Education Annual Meeting (NCME 2026), Los Angeles, CA, United States. \\link{https://www.youtube.com/watch?v=XPnhPopyrnQ&t=587s}{Link to Video}", "ncme_2026.png"),
("Araneda, S., \\& Foster, D. (2025, November 5). \\textit{A phenomenological framework for stakes definition in educational testing} [Virtual conference presentation]. Conference on Test Security (COTS 2025), University of Massachusetts Amherst, Amherst, MA, United States.", "cots2025.png"),
("Araneda, S. (2025, November 4). \\textit{There are many ways to skin a CAT: Exploring alternative ways for doing adaptive testing} [Conference presentation]. Conference on Test Security (COTS 2025), University of Massachusetts Amherst, Amherst, MA, United States.", "cots2025.png"),
("Marder, A., \\& Araneda, S. (2025, November 4). \\textit{Validating Observer for online test security: Preliminary evidence on detecting examinee use of ChatGPT} [Conference presentation]. Conference on Test Security (COTS 2025), University of Massachusetts Amherst, Amherst, MA, United States.", "cots2025.png"),
("Araneda, S., Lee, W.-C., \\& Kim, S. (2025, October 29). \\textit{Equating forms using synthetic data via LLM respondents and DCM models} [Conference presentation]. AIME Conference (AIME-Con), National Council on Measurement in Education (NCME), Pittsburgh, PA, United States. \\link{https://www.researchgate.net/publication/397016164_Equating_Forms_Using_Synthetic_Data_via_LLM_Respondents_and_Auxiliary_DCM_Models}{Link to Slides}", "aimecon.png"),
("Araneda, S. (2025, October 29). \\textit{Tests as socio-technical artifacts: First thoughts on its implications for validity theory} [Conference presentation]. AIME Conference (AIME-Con), National Council on Measurement in Education (NCME), Pittsburgh, PA, United States. \\link{https://www.youtube.com/watch?v=wiZpPjoCtw4}{Link to Video} \\link{https://www.researchgate.net/publication/397016643_Presentation_Tests_as_Socio-Technical_Artifacts_First_Thoughts_on_its_Implications_for_Validity_Theory}{Link to Slides}", "aimecon.png"),
("Araneda, S. (2025, October 28). \\textit{Function ascription, use-plans and how to validate AI tools used in educational testing} [Conference presentation]. AIME Conference (AIME-Con), National Council on Measurement in Education (NCME), Pittsburgh, PA, United States. \\link{https://www.youtube.com/watch?v=WHDiJHOZld8}{Link to Video} \\link{https://www.researchgate.net/publication/397016162_Presentation_Function_Ascription_Use-plans_and_How_to_Validate_AI_Tools_Used_in_Educational_Testing}{Link to Slides}", "aimecon.png"),
("Araneda, S., \\& Foster, C. (2025, October 23). \\textit{Assessing pre-exposure risks of LLM-generated item pools} [Paper presentation]. New England Educational Research Association (NERA) Annual Conference, Trumbull, CT, United States. \\link{https://www.youtube.com/watch?v=VMlFHszRGck}{Link to Video} \\link{https://www.researchgate.net/publication/397016004_Assessing_Pre-Exposure_Risks_of_LLM-Generated_Item_Pools}{Link to Slides}", "nera.png"),
("Araneda, S. (2025, octubre 10). \\textit{Repensando la validez de las pruebas desde la filosof\\'ia de la tecnolog\\'ia: Una perspectiva de artefactos socio-t\\'ecnicos} [Presentaci\\'on en seminario virtual]. Segundo Seminario FEVED: Evaluaci\\'on Educacional Hoy: Entre la Evidencia, la Tecnolog\\'ia y el Aula, Foro de Evaluaci\\'on Educacional de Chile (FEVED).", "feved_seminar.jpg"),
("Araneda, S., Marder, A., Foster, C., Foster, D. (2025, April) \\textit{Reliability in Randomly Parallel Tests: A Practical Guide} [Presentation]. National Council on Measurement in Education annual meeting, Denver. \\link{https://www.researchgate.net/publication/393062009_Reliability_in_Randomly_Parallel_Tests_A_Practical_Guide}{Link to Slides}", "ncme.png"),
("Araneda, S. (2025, April) \\textit{Investigating Different Prompt Engineering Strategies Across Different Content Areas} [Presentation]. National Council on Measurement in Education annual meeting, Denver. \\link{https://www.researchgate.net/publication/391737333_Investigating_Different_Prompt_Engineering_Strategies_Across_Different_Content_Areas}{Link to Slides}", "ncme.png"),
("Araneda, S. (2025, March) \\textit{The arms race of AI and Test Security} [Presentation]. Innovations in Testing, Association of Test Publishers, Orlando. \\link{https://www.researchgate.net/publication/393177302_The_Arms_Race_of_AI_and_Test_Security}{Link to Slides}", "atp.png"),
("Araneda, S. (2024, October) \\textit{Score-Difference-at-Risk (SDaR): Using Risk Metrics to Anticipate the Impact of Test Security Breaches}. [Presentation]. Conference on Test Security, Salt Lake City. \\link{https://www.researchgate.net/publication/393177336_Score-Difference-at-Risk_SDaR_Using_risk_metrics_to_anticipate_the_impact_of_test_security_breaches}{Link to Slides}", "cots_generic.jpg"),
("Araneda, S., Colvin, K., O'Donnell, F., Padellaro, F., Wells, C. (2024, October) \\textit{Prompt Engineering for Binary Response Item Generation Using ChatGPT}. [Presentation]. Northeastern Educational Research Association Annual Meeting, Trumbull.", "nera.png"),
("Araneda, S. (2024, July) \\textit{Score-Difference-at-Risk (SDaR): Using risk metrics to anticipate negative impact}. [Presentation]. IMPS, Praha. \\link{https://www.youtube.com/watch?v=_cEUga7GG60}{Link to Video} \\link{https://www.researchgate.net/publication/393061901_Score-Difference-at-Risk_SDaR_Using_risk_metrics_to_anticipate_negative_impact}{Link to Slides}", "imps.jpg"),
("Foster, C., Weaver, S. \\& Araneda, S. (2024, July) \\textit{Using ChatGPT for Semi-Automatic Generation of Item for Summative Assessment: a Case Study} [Presentation]. International Test Commission Bi-Annual Meeting, Granada. \\link{https://www.researchgate.net/publication/393062177_Using_ChatGPT_for_Semi-Automatic_Generation_of_Item_for_Summative_Assessment_a_Case_Study_ITC_bi-annual_conference_Granada_2024}{Link to Slides}", "itc.png"),
("Araneda, S., Sireci, S., Crespo-Cruz, E. \\& Mena-Serrano, F. (2024, July) \\textit{A Conceptual Framework for Assessment Experience in Educational Testing} [Presentation]. International Test Commission Bi-Annual Meeting, Granada.", "itc.png"),
("Araneda, S. \\& Gonzalez-Wegener, X. (2024, July) \\textit{Studying Test-Taker Experiences Shared on TikTok about Standardized Testing and College Admission in Chile} [Presentation]. International Test Commission Bi-Annual Meeting, Granada.", "itc.png"),
("G\\'andara, F. \\& Araneda, S. (2024, July) \\textit{Change is never easy: the case of Chilean University admissions and their new battery of standardized tests PAES} [Presentation]. International Test Commission Bi-Annual Meeting, Granada.", "itc.png"),
("Foster, D., Foster, C., Marder, A. \\& Araneda, S. (2024, April) \\textit{Evaluating the test security benefits of randomly parallel tests: protecting against pre-knowledge} [Presentation]. National Council on Measurement in Education annual meeting, Philadelphia. \\link{https://www.youtube.com/watch?v=A6fOUrriuK4}{Link to Video} \\link{https://www.researchgate.net/publication/393062010_Evaluating_the_Test_Security_Benefits_of_Randomly_Parallel_Tests_Protecting_Against_Pre-Knowledge}{Link to Slides}", "ncme.png"),
("Araneda, S. (2024, March) \\textit{Comparing Humans, NLP models and LLMs to create binary response items}. [Presentation]. Innovations in Testing, Association of Test Publishers, Anaheim. \\link{https://youtu.be/kl1XSzNrWWs}{Link to Video} \\link{https://www.researchgate.net/publication/393062272_Comparing_Humans_NLP_Models_and_LLMs_to_Create_Binary_Response_Items}{Link to Slides}", "atp.png"),
("Araneda, S. (2022, April) \\textit{Situating the validity argument: lessons from feminist epistemologies} [Paper presentation]. National Council on Measurement in Education annual meeting, San Diego. \\link{https://www.youtube.com/watch?v=ghipI3boCwU}{Link to Video}", "ncme.png"),
("Araneda, S., Lee, D., Lewis, J., O'Riordan, M., Sireci, S. \\& Zenisky, A. L. (2021, October) \\textit{Incorporating SmartItem\\texttrademark\\ Technology on a Multistage-Adaptive Test}. Northeastern Educational Research Association annual meeting [Virtual].", "nera.png"),
("Sireci, S. \\& Araneda, S. (2021, June) \\textit{Think Positive: How to Use Assessments to Bolster Student Learning} [Paper presentation]. National Council on Measurement in Education annual meeting [Virtual].", "ncme.png"),
("Araneda, S. \\& Sireci, S. (2021, June) \\textit{An Experiential approach to test design and validation} [Paper presentation]. National Council on Measurement in Education annual meeting [Virtual].", "ncme.png"),
("Araneda, S., Arslan, B., Keehner, M., Lee, D., Lehman, B., Lewis, J., Moon, J. \\& Sireci, S. (2021, June) \\textit{Exploring Relationships Among Examinees' Behaviors and Performance Using Response Process Data} [Paper presentation]. National Council on Measurement in Education annual meeting [Virtual]. \\link{https://www.researchgate.net/publication/352447567_Exploring_Relationships_Among_Examinees'_Behaviors_and_Performance_Using_Response_Process_Data}{Link to Slides}", "ncme.png"),
]

CONF_DEMOS = [
("Araneda, S. (2024, October) \\textit{Using ChatGPT for the Automatic Creation of SmartItems\\texttrademark\\ for the Purposes of Test Security and Personalized Assessment}. [Demonstration]. Conference on Test Security, Salt Lake City.", "cots_generic.jpg"),
("Araneda, S. \\& Foster, D. (2023, October) \\textit{Using ChatGPT for the Automatic Creation of Smartitems\\texttrademark\\ for the Purposes of Test Security and Culturally Responsive Assessment}. [Demonstration]. Conference on Test Security, Tempe. \\link{https://youtu.be/LykchEfB1ic}{https://youtu.be/LykchEfB1ic}", "cots_generic.jpg"),
("Araneda, S., Foster, D. (2023, April) \\textit{SmartItem\\texttrademark: using Automatic Item Generation for Test Security} [Demonstration]. National Council on Measurement in Education annual meeting, Chicago.", "ncme.png"),
("Araneda, S. (2022, April) \\textit{Reliability challenge! A Game to teach CTT reliability in educational measurement} [Demonstration]. National Council on Measurement in Education annual meeting, San Diego.", "ncme.png"),
]

CONF_POSTERS = [
("Araneda, S. \\& Sireci, S. (2023, April) \\textit{Sketching a Validity Argument from User Experiences Shared on Twitter} [Poster presentation]. National Council on Measurement in Education annual meeting, Chicago.", "ncme.png"),
("Araneda, S., Keller, L. (2023, April) \\textit{An Experiential Approach in Classroom Assessment: Centering Test Design around Elicited Experiences} [Poster presentation]. American Educational Research Association Annual Meeting, Chicago.", "aera.png"),
("Araneda, S., Silva, M. \\& Varas, L. (2020, Apr 17 - 21) \\textit{Improving equity in university admission through a class rank measure: Easier said than done} [Poster Session]. American Educational Research Association Annual Meeting, San Francisco (Conference Canceled). \\link{http://tinyurl.com/wvpvjzq}{http://tinyurl.com/wvpvjzq} \\link{https://www.researchgate.net/publication/342376731_Impacto_del_ranking_de_notas_en_el_acceso_a_las_universidades_del_Sistema_Unico_de_Admision}{Link to Slides}", "aera.png"),
]

CONF_DISCUSSANT = [
("Araneda, S. (2025, April). \\textit{Test Security: Fraudulent Behavior Detection Methods} [Discussant]. National Council on Measurement in Education Annual Meeting, Denver.", "ncme.png"),
]

SOCIAL_INDIVIDUAL = [
("Araneda, S. (2024, August) \\textit{Securing Tests with AI: Initial Explorations in Item Generation}. [Virtual] Artificial Intelligence in Educational Measurement SIGIMIE, NCME. \\link{https://www.youtube.com/watch?v=eH-QbBkeYQo}{Link to Video}", "ncme.png"),
("Araneda, S. (2021, June) \\textit{An Experiential approach to test design and validation} [Paper presentation]. Edmund Gordon Centennial Celebration: Sustaining Diversity, Culture, and Identity in Pedagogies and Assessments [Virtual]. \\link{https://www.youtube.com/watch?v=4n_BX6zW8L4&t=233s}{Link to Video}", "umass_seal.png"),
]

SOCIAL_ORG_ONLINE = [
("Labarca, L., Zunino, V., \\& Araneda, S. (Organizers). (2025, October 10). Segundo Seminario FEVED: Evaluaci\\'on educacional hoy: Entre la evidencia, la tecnolog\\'ia y el aula [Virtual conference]. FEVED. Retrieved from \\link{https://sites.google.com/view/feved/seminarios-feved/segundo-seminario?authuser=0&utm_source=chatgpt.com}{https://sites.google.com/view/feved/seminarios-feved/segundo-seminario?authuser=0}", "feved_seminar.jpg"),
]

SOCIAL_WEBINAR_SINGLE = [
("Araneda, S., G\\'andara, F., Santelices, V., Torres-Iribarra, D., Zunino, V. (2021, May) \\textit{Pruebas Estandarizadas y Sistemas de evaluaci\\'on de aprendizajes en Chile durante y post pandemia}. [Virtual] Nexos Chile-USA \\& FEVED. \\linkurltext{https://www.youtube.com/watch?v=4rYXu75fn-k&t=3944s}{https://www.youtube.com/watch?v=4rYXu75fn-k}", "nexos.png"),
]

def series_entry(title, subtitle, body, logo):
...
VOLUNTEER = [
("Committee member, Website Committee", "May 2025 -- April 2026",
 "I am a member of the Website Committee at NCME. We helped on the transition to the new website.", "ncme.png"),
("Vice-coordinator, FEVED Foro chileno de profesionales en evaluaci\\'on educacional (Chilean Forum of professionals in educational assessment).", "March 2025 -- February 2026",
 "Working together with Loretta Labarca in the coordination of FEVED, an advocacy group of Measurement and Assessment Professionals in Chile for best practices in Educational Testing. More info (in Spanish) \\link{http://www.feved.cl/}{www.feved.cl}", "feved.png"),
("Committee member, Diversity Issues in Testing Committee (CODIT)", "May 2024 -- April 2025",
 "I was a member of the Diversity Issues in Testing Committee (CODIT) at NCME. I served as a reviewer of some assignments specific of the committee.", "ncme.png"),
("Chair, NCME Graduate Student Issues Committee (GSIC).", "July 2021 -- May 2023",
 "I was one of the chairs of the NCME Graduate student issues committee (GSIC). This committee is in charge of raising the concerns and voices of graduate students to the NCME board and organizing social events for the graduate students. I led different types of activities, with great evaluation from the NCME board during my term as a Senior Chair in the annual conference in Chicago (2023).", "ncme.png"),
("Coordinator, NCME-GSIC Standards study group \\& Statement New Edition of the Standards", "October 2021 -- April 2023",
 "I led a study group focusing on the current version of the Standards, doing a series of discussions among students and Q\\&A sessions with experts. In the second stage of the study group, we wrote a statement about the new Edition of the Standards with our position as a generation. Find more info about the Standards Study Group \\link{https://www.ncme.org/students/student-programs/standards-study-group}{here}.", "ncme.png"),
("Coordinator, FEVED Foro chileno de profesionales en evaluaci\\'on educacional (Chilean Forum of professionals in educational assessment).", "September 2020 -- August 2021",
 "First coordinator of the group FEVED.", "feved.png"),
]

def build():
    parts = [PREAMBLE, HEADER, WORK_EXPERIENCE, SKILLS, TEACHING, PUB_HEADER, journals(), book_chapters()]
    parts.append(r"\cvsubsection{Pre-prints}" + "\n")
    for text, logo in PREPRINTS:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{White papers \& Dissertation}" + "\n")
    for text, logo in WHITEPAPERS:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Newspapers}" + "\n")
    ...
    for text, logo in CONF_ORGANIZED:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Panel Participation}" + "\n")
    for text, logo in CONF_PANEL:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Training Sessions}" + "\n")
    for text, logo in CONF_TRAINING:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Individual Presentations}" + "\n")
    for text, logo in CONF_INDIVIDUAL:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Demonstrations}" + "\n")
    for text, logo in CONF_DEMOS:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Posters}" + "\n")
    for text, logo in CONF_POSTERS:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Discussant}" + "\n")
    ...
    for text, logo in SOCIAL_INDIVIDUAL:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Organized Online Conferences}" + "\n")
    for text, logo in SOCIAL_ORG_ONLINE:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Organized Single Webinars}" + "\n")
    for text, logo in SOCIAL_WEBINAR_SINGLE:
        parts.append(f"\\pubentry{{{text}}}{{{logo}}}\n")
    parts.append(r"\cvsubsection{Organized Webinar Series}" + "\n")
    ...
    parts.append("\n\\end{document}\n")
    text = "".join(parts)
    # \link{URL}{URL} (identical href/display => a bare URL shown as text)
    # needs seqsplit so it can break across lines; short labels don't.
    import re
    def collapse(m):
        a, b = m.group(1), m.group(2)
        return f"\\linkurl{{{a}}}" if a == b else m.group(0)
    text = re.sub(r"\\link\{([^{}]+)\}\{([^{}]+)\}", collapse, text)
    return text
